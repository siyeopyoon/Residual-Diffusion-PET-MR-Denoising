...
network_dir=f"{rootpath}/Random/MICCAI_2024/petmr/Models/diffusion_noMR/network-snapshot-{itersnames}-noMR.pkl"
...
outroot_infer = f"{rootpath}/Random/MICCAI_2024/petmr/Inference/diffusion_noMR_{itersnames}_{steps}/"
