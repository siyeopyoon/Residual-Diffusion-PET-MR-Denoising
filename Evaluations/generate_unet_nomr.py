...
network_dir=f"{rootpath}/Random/MICCAI_2024/petmr/Models/unet_noMR/network-snapshot-{itersnames}-noMR.pkl"
...
outroot_infer = f"{rootpath}/Random/MICCAI_2024/petmr/Inference/unet_noMR/"
