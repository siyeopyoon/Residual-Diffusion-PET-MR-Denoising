...
if local_save:
    ...
    # rootpath = "H:"
    itersnames = "002048"
    keyword="transformer_noMR"
    steps = 100

    network_dir = f"{rootpath}/Random/MICCAI_2024/petmr/Models/{keyword}/network-snapshot-{itersnames}.pkl"
...
def main(network_pkl, resolution, on_latents, embed_fq, mask_pos, x_start, y_start, image_size, outdir, subdirs,
    ...
    network_pkl =network_dir        # Load network.
