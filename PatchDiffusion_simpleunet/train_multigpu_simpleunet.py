...
from training import training_loop_multigpu_simpleunet
...
results_dir = f"/external/1_Codes/4_ScBridge/PatchDiffusion_simpleunet/results_simpleunet/"
...
#        c = dnnlib.EasyDict()
    ...
    c.dim3d=opts.dim3d
    c.network_kwargs.update(model_type='SimpleUnet', embedding_type='positional', encoder_type='standard',
...
#    dist.print0(f'Class-conditional:       {c.dataset_kwargs.use_labels}')
   ...
   # else:
    #    c.device = torch.device('cpu')
    # Train.
    training_loop_multigpu_simpleunet.training_loop(**c)
