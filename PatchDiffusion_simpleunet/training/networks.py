...
class SimpleUnet(nn.Module):
    ...
    def create_model(self):
        ...
        # block_1_1
        block_1_1 = []
        block_1_1.extend(self.add_block_conv(in_channels=self.in_channels, out_channels=64, kernel_size=kernel_size, stride=1,
        ...
        block_1_2.extend(self.add_block_conv(in_channels=64, out_channels=64, kernel_size=kernel_size, stride=1,
                                             padding=padding, batchOn=True, ReluOn=True))
        block_1_2.extend(self.add_block_conv(in_channels=64, out_channels=self.in_channels, kernel_size=1, stride=1,
                                             padding=0, batchOn=False, ReluOn=False))
        block_1_2.extend(self.add_block_conv(in_channels=self.in_channels, out_channels=self.out_channels, kernel_size=1, stride=1,
                                             padding=0, batchOn=False, ReluOn=False))
